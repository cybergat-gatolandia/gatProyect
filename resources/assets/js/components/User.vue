                            ...
                            <thead>
                               <tr class="text-center ">
                                    <div class="row table-primary">
                                        <!--  -->
                                        <!--<th class="col-lg-2  col-sm-3 col-md-3 col-xs-12">Id</th>-->
                                        <!--<th class ="col-lg-3 col-md-3 col-sm-3 col-xs-12">Id_Rol</th>-->
                                        <th class ="col-lg-5 col-md-4 col-sm-4 col-xs-12">nombre</th>
                                        <th class ="col-lg-2 col-md-2 col-sm-2 col-xs-12">Estado</th>
                                        <th class ="col-lg-2 col-md-2 col-sm-2 col-xs-12">Opciones</th>
                                    </div>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="user in arrayUser" :key="user.id" class="row text-center table-sm"> 
                                    <td class="col-lg-2  col-sm-3 col-md-3 col-xs-12">
                                        <button type="button" @click= "abrirModal('user','actualizar',user)" class="btn btn-info btn-sm" >
                                            <i class="icon-pencil"></i>
                                        </button> &nbsp;
                                        <template v-if="user.estado">
                                            <button type="button" class="btn btn-warning btn-sm" @click="desactivarRol(user.id)">
                                                <i class="icon-trash"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <button type="button" class="btn btn-primari btn-sm" @click="activarRol(user.id)">
                                    ...
                                    <td class ="col-lg-5 col-md-4 col-sm-4 col-xs-12" v-text="rols.nombre"></td>
                                    <td class ="col-lg-5 col-md-4 col-sm-4 col-xs-12" v-text="user.condicion"></td>
        ...
        methods : {
            ...
            registrarUser(){
                if(this.validarUser()){
                 ...
                 // INSERTAR EN LA TABLA Y VERIFICAR LOS DATOS
                let me = this;
